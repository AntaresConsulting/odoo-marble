...
#        return res
    ...
    _columns = {
        ...
        'type': fields.selection(_get_type, string='Type', select=True, states={'done':[('readonly', True)]}),

        'state': fields.selection([('draft', 'Draft'),('done', 'Dimensioned')],'Status', readonly=True, select=True),
